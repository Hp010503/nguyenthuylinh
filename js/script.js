...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Tham số cho TEXT
    const MAX_ACTIVE_TEXTS = 500;     // Số lượng chữ tối đa được hiển thị cùng một lúc
    const TEXT_CREATION_INTERVAL = 500; // ms, tần suất tạo ra chữ mới (càng nhỏ, chữ xuất hiện càng thường xuyên)
